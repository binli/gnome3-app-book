/* hello_vala.c generated by valac 0.26.0, the Vala compiler
 * generated from hello_vala.vala, do not modify */
...
Main* main_construct (GType object_type) {
	...
	_tmp0_ = book_new ("1234", "A new book");
	book = _tmp0_;
	book_printISBN (book);
	_g_object_unref0 (book);
	return self;
}
